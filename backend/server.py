...
from fastapi import FastAPI, APIRouter, HTTPException, Depends, status, WebSocket, WebSocketDisconnect, Request, Query, Body
...
<Response></Response>""",
    ...
    # Check if this is an outbound call leg (From is a virtual number)
